          ...
          <div class="custom-table">
            ...
            >
              <template #cell(type)="row">
                {{ row.item.type === 0 ? "Precios por libras" : "Precio fijo" }}
              </template>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: "telephone", label: "Télefono" },
        { key: "alternativeTelephone", label: "Télefono alternativo" },
        { key: "nameCharge", label: "Nombre del representante" },
        { key: "telephoneCharge", label: "Télefono del representante" },
        {
          key: "alternativeTelephoneCharge",
          label: "Télefono alternativo del representante",
        },
        { key: "type", label: "Tipo" },
  ...
  methods: {
    ...
    get() {
      ...
      axios
        .get(
          this.api() +
            `/customers?show=${this.show}&search=${this.search}&page=${this.pagination.current_page}`
        )
        .then((response) => {
          this.isBusy = false;
