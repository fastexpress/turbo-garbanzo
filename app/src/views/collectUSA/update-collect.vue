...
export default {
  ...
  methods: {
    ...
    find() {
      ...
      axios
        .get(this.api() + `/collect/${this.$route.params.id}`)
        .then((response) => {
          loader.hide();
          ...
          this.departament = {
            id: response.data.departament.id,
            name: response.data.departament.name,
          };
          this.getTowns(this.departament);
          this.town = {
            id: response.data.town.id,
            name: response.data.town.name,
          };
