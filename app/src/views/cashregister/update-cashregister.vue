...
export default {
  metaInfo: { title: "Actualizar caja" },
  directives: { money: VMoney },
  data() {
    return {
      breadcrumb: [
        { text: "Inicio", href: "/" },
        { text: "Actualizar caja", active: true },
      ],
      quetzal: {
        decimal: ".",
        thousands: ",",
  ...
  methods: {
    ...
    find() {
      ...
      axios
        .get(this.api() + `/cashregister/${this.$route.params.id}`)
        .then((response) => {
          loader.hide();
    ...
    handleSubmit() {
      let loader = this.$loading.show();
      axios
        .put(this.api() + `/cashregister/${this.id}`, {
          name: this.name,
