        ...
        <div class="panel br-6 p-0">
          <div class="custom-table">
            <div class="table-header">
              ...
              <download
                :typeReport="{ name: 'Entregado', value: 'DELIVERED' }"
                :customer="customer"
              />
            </div>
          </div>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: "inDeliveredDate", label: "Entrega" },
  ...
  methods: {
    ...
    get(customer) {
      ...
      axios
        .get(
          this.api() +
            `/search-package-ups-delivered?show=${this.show}&search=${this.search}&page=${this.pagination.current_page}&customer=${customer}`
        )
        .then((response) => {
          this.isBusy = false;
