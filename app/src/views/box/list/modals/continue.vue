<template>
  ...
  >
    <ValidationObserver ref="observer">
      <b-form>
        <!-- RECEIVE -->
        <ValidationProvider rules="required" name="observación">
...
export default {
  ...
  methods: {
    ...
    openModal(upsPackage) {
      ...
      this.$refs["modal_route_continue"].show();
    },
    handleSubmit() {
      this.$refs["observer"].validate().then((isValid) => {
        if (isValid) {
          ...
          axios
            .post(this.api() + "/package-ups-continue", {
              id: this.id,
    ...
    closeModal() {
      this.observation = "";
      this.$refs["modal_route_continue"].hide();
    },
  },
};
</script>