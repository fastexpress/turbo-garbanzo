...
import modalPackage from "./new-modals/modal-package-new.vue";
import modalUpdatePackge from "./new-modals/modal-package-update.vue";
...
export default {
  metaInfo: { title: "Nuevo paquete" },
  data() {
    return {
      breadcrumb: [
        { text: "Inicio", href: "/" },
        { text: "Nuevo paquete", active: true },
      ],
      columns: [
        { key: "id", label: "ID" },
