<template>
  <div>
    <b-button block variant="secondary" @click="openModal"
      >Agregar paquete</b-button
    >
    <b-modal
      ref="modal_add_package"
...
export default {
  ...
  methods: {
              ...
              axios
                ...
                .then((response) => {
                  ...
                  this.setPackage({
                    ...
                    baler: this.baler,
                    guide: this.guide,
                    office: this.office_guatemala,
                    observation: this.observation,
                    updatedMultiplier: this.updatedMultiplier,
                    multiplier: this.multiplier,
                  });
                  this.clearData();
                  this.$emit("save-package");
                  this.closeModal();
                })
                .catch((err) => {
                  loader.hide();
    ...
    closeModal() {
      this.$refs["modal_add_package"].hide();
    },
    openModal() {
      this.$refs["modal_add_package"].show();
      // PACKAGE
      const myPackage = this.getPackage();
      if (!this.isObjEmpty(myPackage)) {
        this.send = myPackage.send;
        this.departament = myPackage.departament;
        this.type = myPackage.type;
        this.cancel = myPackage.payment;
        this.office_guatemala = myPackage.office;
      }
      // END PACKAGE
    },
    calculateTotal() {
